<template>
  <el-main class="main">
    <el-main v-for="(friend,index) in followfriendList " :key="index">
      <!--头像和名字-->
      ...
      <el-main class="button">
        <el-badge  class="item">
          <el-button size="small" class="el-icon-s-comment" @click="addComment(friend.cfId,user.id)"></el-button>
        </el-badge>
        &nbsp;&nbsp;&nbsp;
...
<script>
  ...
  export default {
    ...
    methods:{
      findUserById:function () {
        axios.post("http://localhost:7000/s-circle of friend/circleFriend/findUserById").then(res=>{
          if (res.data.code==200){
              ...
              this.findFollowFriends(this.user.id)
      ...
      findAllRemark:function(){
        axios.get("http://localhost:7000/s-circle of friend/circleFriend/findAllRemark").then(res=>{
          if (res.data.code == 200){
      ...
      findFollowFriends:function(id){
        axios.get("http://localhost:7000/s-circle of friend/circleFriend/findFollowFriends?id="+ id).then(res=>{
          if (res.data.code==200){
            console.log(res.data.data)
            this.followfriendList = res.data.data
          }
        })
      },
    },
